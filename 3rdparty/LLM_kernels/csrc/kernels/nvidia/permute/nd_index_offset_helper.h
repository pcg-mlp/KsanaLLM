...
public:
    ...
    __device__ __host__ __forceinline__ explicit NdIndexOffsetHelper(const T* dims)
    {
        InitStrides(dims, N);
    }
    ...
    __device__ __host__ __forceinline__ explicit NdIndexOffsetHelper(const T* dims, int n)
    {
        InitStrides(dims, n);
    }
...
#pragma unroll
    ...
    __device__ __host__ __forceinline__ constexpr int Size() const
    {
        return N;
    }
