...
#include "csrc/kernels/nvidia/asymmetric_gemm/weightOnlyBatchedGemv/converter.h"
#include "csrc/kernels/nvidia/asymmetric_gemm/weightOnlyBatchedGemv/details.h"
#include "csrc/kernels/nvidia/asymmetric_gemm/weightOnlyBatchedGemv/utility.h"
...
#pragma unroll
    for (int i = 0; i < CtaN; ++i) {
      ...
      dequantize<Details, 1, StepK, EnableZero, ApplyAlphaInAdvance>(tile_w, tile_w_quantized, vec_scale + i,
                                                                     vec_zero + i, alpha);
