...
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/collective/collective_builder_gated.hpp"
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/kernel/gemm_universal_gated.hpp"
...
struct DeviceGemmGatedSm90 {
  ...
  using CollectiveEpilogue = typename cutlass::epilogue::collective::CollectiveBuilder<
      ...
      ElementC, LayoutC, AlignmentC, ElementOutput, LayoutOutput, AlignmentOutput, EpilogueSchedule,
      FusionOperation>::CollectiveOp;

  using CollectiveMainloop = typename cutlass::gemm::collective::CollectiveBuilderGated<
