...
size_t typedGemmGatedKernelLauncher(Gemm gemm, typename Gemm::Arguments args, void* D, void const* A, void const* B,
                                    void const* C_bias, char* workspace, size_t workspaceBytes, cudaStream_t stream,
  ...
  if (smem_size > mMaxSmemSize) {
    ...
    throw std::runtime_error("[Error][fusedGatedGemm Runner] " + errMsg);
  }
...
typename Gemm::Arguments prepareGemmArgsSm90(void* D, void const* A, void const* B, void const* C_bias,
                                             ...
                                             float scale_d0, float scale_d1, float scale_output,
...
size_t genericGemmGatedKernelLauncherSm90(void* D, void const* A, void const* B, void const* C_bias,
  ...
  using MainloopScheduleType =
      cute::conditional_t<size<0>(CTAShape{}) == Int<64>{}, cutlass::gemm::KernelTmaWarpSpecializedPingpongFP8FastAccum,
  ...
  auto args = prepareGemmArgsSm90<Gemm, SwapAB>(D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output,
                                                gemmConfig);
  return typedGemmGatedKernelLauncher(Gemm{}, args, D, A, B, C_bias, workspace, workspaceBytes, stream, occupancy);
#else   // COMPILE_HOPPER_TMA_GEMMS
  throw std::runtime_error(
      "[Error][GemmGatedKernelLauncherSm90] Please recompile with support for hopper by passing 90-real "
...
size_t dispatchGemmConfigSm90(void* D, void const* A, void const* B, void const* C_bias,
                              llm_kernels::utils::QuantMode quantOption, int m, int n, int k, float scale_d0,
                              float scale_d1, float scale_output,
  ...
  switch (gemmConfig.cluster_shape) {
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_1x1x1:
      return genericGemmGatedKernelLauncherSm90<T, CTAShape, Shape<_1, _1, _1>>(
          D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output, gemmConfig, workspace,
          workspaceBytes, stream, occupancy);
      break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_2x1x1:
      return genericGemmGatedKernelLauncherSm90<T, CTAShape, Shape<_2, _1, _1>>(
          D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output, gemmConfig, workspace,
          workspaceBytes, stream, occupancy);
      break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_1x2x1:
      return genericGemmGatedKernelLauncherSm90<T, CTAShape, Shape<_1, _2, _1>>(
          D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output, gemmConfig, workspace,
          workspaceBytes, stream, occupancy);
      break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_2x2x1:
      return genericGemmGatedKernelLauncherSm90<T, CTAShape, Shape<_2, _2, _1>>(
          D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output, gemmConfig, workspace,
          workspaceBytes, stream, occupancy);
      break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_1x8x1:
      return genericGemmGatedKernelLauncherSm90<T, CTAShape, Shape<_1, _8, _1>>(
          D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output, gemmConfig, workspace,
          workspaceBytes, stream, occupancy);
      break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_8x1x1:
      return genericGemmGatedKernelLauncherSm90<T, CTAShape, Shape<_8, _1, _1>>(
          D, A, B, C_bias, quantOption, m, n, k, scale_d0, scale_d1, scale_output, gemmConfig, workspace,
          workspaceBytes, stream, occupancy);
      break;
    default:
      throw std::runtime_error(
          "[Error][CutlassFusedGatedGemmRunner][dispatchGemmConfigSm90] Config is invalid for fused "
          "gated GEMM.");
      break;
  }
}
  ...
  switch (gemmConfig.tile_config_sm90) {
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x16x128B:
      return dispatchGemmConfigSm90<T, Shape<_64, _16, _Ktile>>(D, A, B, C_bias, quantOption, m, n, k, scale_d0,
                                                                scale_d1, scale_output, gemmConfig, workspace,
                                                                workspaceBytes, stream, occupancy);
      break;
    ...
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::Undefined:
      throw std::runtime_error(
          "[Error][CutlassFusedGatedGemmRunner][dispatchGemmToCutlassSm90] gemm config undefined.");
      break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::ChooseWithHeuristic:
      throw std::runtime_error(
          "[Error][CutlassFusedGatedGemmRunner][dispatchGemmToCutlassSm90] gemm config should have "
          "already been set by "
          "heuristic.");
      break;
    default:
      throw std::runtime_error(
          "[Error][CutlassFusedGatedGemmRunner][dispatchGemmToCutlassSm90] Config is invalid for fused "
          "gated GEMM.");
      break;
  }
}
...
template <typename T>
size_t CutlassFusedGatedGemmRunner<T>::dispatchToArch(
    void* D, void const* A, void const* B, void const* C_bias, llm_kernels::utils::QuantMode quantOption, int m, int n,
    int k, float scale_d0, float scale_d1, float scale_output,
    llm_kernels::nvidia::cutlass_extensions::CutlassGemmConfig gemmConfig, char* workspace, size_t workspaceBytes,
  ...
  if constexpr (std::is_same_v<T, __nv_fp8_e4m3>) {
    if (mSm == 90) {
      ...
      throw std::runtime_error(
          "[Error][CutlassFusedGatedGemmRunner][GEMM Dispatch] Arch unsupported for CUTLASS fused "
          "gated GEMM");
    }
  } else {
    throw std::runtime_error(
        "[Error][CutlassFusedGatedGemmRunner][GEMM Dispatch] dtype unsupported for CUTLASS fused "
        "gated "
        "GEMM");
  }
  return 0;
...
template <typename T>
std::vector<llm_kernels::nvidia::cutlass_extensions::CutlassGemmConfig> CutlassFusedGatedGemmRunner<T>::getConfigs()
    const {
  ...
  using llm_kernels::nvidia::cutlass_extensions::SplitKStyle;
  ...
  if constexpr (std::is_same_v<T, __nv_fp8_e4m3>) {
    ...
    candidateConfigs.erase(
        std::remove_if(
            candidateConfigs.begin(), candidateConfigs.end(),
            [](auto const& config) {
              return config.tile_config_sm90 ==
                         llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x256x128B ||
                     config.tile_config_sm90 ==
                         llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x256x128B;
            }),
        candidateConfigs.end());
    std::vector<llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90> tilesSm90 = {
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x16x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x32x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x64x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x128x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x16x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x32x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x64x128B,
        llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x128x128B};
    for (auto const& tile_config : tilesSm90) {
      {
        CutlassGemmConfig config(tile_config, llm_kernels::nvidia::cutlass_extensions::MainloopScheduleType::AUTO,
                                 llm_kernels::nvidia::cutlass_extensions::EpilogueScheduleType::AUTO,
                                 llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_1x8x1);
        candidateConfigs.push_back(config);
      }
      {
        CutlassGemmConfig config(tile_config, llm_kernels::nvidia::cutlass_extensions::MainloopScheduleType::AUTO,
                                 llm_kernels::nvidia::cutlass_extensions::EpilogueScheduleType::AUTO,
                                 llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_8x1x1);
        candidateConfigs.push_back(config);
      }
    }
  } else {
  ...
  for (auto const& gemmConfig : gemmConfigs) {
    try {
      size_t curr_workspace_size = CutlassFusedGatedGemmRunner<T>::dispatchToArch(
          nullptr, nullptr, nullptr, nullptr, llm_kernels::utils::QuantMode{}, m, n, k, 1.0, 1.0, 1.0, gemmConfig,
          nullptr, 0, 0);
