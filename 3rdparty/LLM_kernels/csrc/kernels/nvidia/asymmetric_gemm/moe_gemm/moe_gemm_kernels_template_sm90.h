...
{
    static_assert(isValidHopperMOESpecialisation<T, WeightType, EpilogueTag>(),
    ...
    //            genericMoeGemmKernelLauncherHopper<T, WeightType,
    //                            cutlass::arch::Sm90, EpilogueTag, true>
    //                                           :
    //                                           genericMoeGemmKernelLauncherHopper<T,
    //                                           WeightType,
    //                                               cutlass::arch::Sm90, EpilogueTag, false>;
    // TODO(dastokes) Re-enable bias when CUTLASS supports it
    auto func = sm90_generic_moe_gemm_kernelLauncher<T, WeightType, OutputType, EpilogueTag,
...
#define SHAPE_CASE(M, N, K)                                                                                            \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            KLLM_KERNEL_THROW("Unsupported tile and cluster shape combination");                                              \
        }                                                                                                              \
    }
...
#undef SHAPE_CASE
    default: KLLM_KERNEL_THROW("Unsupported config for MoE gemm.");
    }
...
#undef SHAPE_CASE
    case cutlass_extensions::CutlassTileConfigSM90::Undefined: KLLM_KERNEL_THROW("GEMM config undefined."); break;
    case cutlass_extensions::CutlassTileConfigSM90::ChooseWithHeuristic:
        ...
        break;
    default: KLLM_KERNEL_THROW("Unsupported config for MoE gemm."); break;
    }
}
