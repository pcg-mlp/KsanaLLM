...
#include <csrc/kernels/nvidia/cutlass_extensions/gemm/kernel/fused_moe_kernel.cuh>
    ...
    int* kernel_occupancy)
{
    ...
    if (kernel_occupancy != nullptr)
    {
        ...
        if (smem_size > (48 << 10))
        {
            ...
            llm_kernels::utils::CHECK_NVIDIA_CUDA_ERROR(cudaGetDevice(&device));
            llm_kernels::utils::CHECK_NVIDIA_CUDA_ERROR(
                cudaDeviceGetAttribute(&max_smem_per_block, cudaDevAttrMaxSharedMemoryPerBlockOptin, device));
            llm_kernels::utils::CHECK_NVIDIA_CUDA_ERROR(cudaFuncGetAttributes(&attr, fused_moe::run_global<GemmType>));
        ...
        llm_kernels::utils::CHECK_NVIDIA_CUDA_ERROR(cudaOccupancyMaxActiveBlocksPerMultiprocessor(
    ...
    if (GemmType::kSmemSize >= (48 << 10))
    {
        ...
        KLLM_KERNEL_CHECK_WITH_INFO(result == cudaSuccess,
