...
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/threadblock/dq_mma_multistage.h"
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/warp/default_mma_tensor_op.h"
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/warp/mma_tensorop_compute_B_with_f16.h"
#include "csrc/kernels/nvidia/cutlass_extensions/tile_interleaved_layout.h"

#include "csrc/kernels/nvidia/cutlass_extensions/gemm/threadblock/default_dq_mma.h"
#include "csrc/kernels/nvidia/cutlass_extensions/transform/threadblock/fine_grained_scale_zero_iterator.h"
...
template <typename MmaShape, typename Element, typename Layout, WeightOnlyQuantOp QuantOp, int32_t Alignment,
...
struct DqMma<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB, kAlignmentB, ElementScale, LayoutScale, kAlignmentScale,
 ...
 private:
  static constexpr int32_t ColumnsInterleaved = LayoutB::kColumnsInterleaved;
  static constexpr int32_t RowsPerTile = LayoutB::kRowsPerTile;
