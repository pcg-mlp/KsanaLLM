...
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/threadblock/default_dq_mma_multistage.h"
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/threadblock/default_dq_mma_pipelined.h"
#include "csrc/kernels/nvidia/cutlass_extensions/gemm/threadblock/default_mma_bf16.h"
...
struct DefaultMma<cutlass::half_t, LayoutA, kAlignmentA, uint8_t, LayoutB, kAlignmentB, ElementAccumulator,
                  ...
                  Operator> {
 private:
  static constexpr int32_t kAlignmentScale = 128 / sizeof_bits<half_t>::value;
