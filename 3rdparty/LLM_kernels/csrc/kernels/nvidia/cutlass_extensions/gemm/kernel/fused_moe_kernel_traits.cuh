...
#include <csrc/kernels/nvidia/cutlass_extensions/gemm/kernel/moe_cute_util.cuh>
#include <csrc/kernels/nvidia/cutlass_extensions/gemm/kernel/moe_problem_visitor.h>
...
template <>
constexpr Activation_Type EpilogueRouting<llm_kernels::nvidia::cutlass_extensions::EpilogueOpDefault>(bool /*is_gate*/) {
  return Activation_Type::Identity;
}

template <>
constexpr Activation_Type EpilogueRouting<llm_kernels::nvidia::cutlass_extensions::EpilogueOpDefaultReLU>(bool /*is_gate*/) {
  return Activation_Type::Relu;
}

template <>
constexpr Activation_Type EpilogueRouting<llm_kernels::nvidia::cutlass_extensions::EpilogueOpDefaultSilu>(bool is_gate) {
  return is_gate ? Activation_Type::Swiglu : Activation_Type::Silu;
}

template <>
constexpr Activation_Type EpilogueRouting<llm_kernels::nvidia::cutlass_extensions::EpilogueOpDefaultFtGelu>(bool is_gate) {
