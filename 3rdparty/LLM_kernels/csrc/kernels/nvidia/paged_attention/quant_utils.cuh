/*
 * Adapted from
 * https://github.com/vllm-project/vllm/blob/v0.3.2/csrc/quantization/fp8_e5m2_kvcache/quant_utils.cuh
 * and
 * https://github.com/vllm-project/vllm/blob/v0.3.2/csrc/attention/dtype_fp8_e5m2.cuh
...
// fp8 -> half
template<>
__inline__ __device__ half vec_conversion<half, uint8_t>(const uint8_t& a)
{
    __half_raw res = __nv_cvt_fp8_to_halfraw(a, __NV_E5M2);
...
// half -> fp8
template<>
__inline__ __device__ uint8_t vec_conversion<uint8_t, half>(const half& a)
{
    __half_raw tmp(a);
    //tmp.x = a;
