 ...
 * and
 * https://github.com/vllm-project/vllm/blob/v0.2.3/csrc/attention/dtype_bfloat16.cuh
...
inline __device__ float2 fma(__nv_bfloat16 a, __nv_bfloat162 b, float2 fc) { return fma(bf162bf162(a), b, fc); }
