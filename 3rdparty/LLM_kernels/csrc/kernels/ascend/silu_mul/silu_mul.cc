...
template <>
void InvokeSiluMul(const aclFloat16* input, const aclFloat16* weight, const size_t m, const size_t n,
                   aclFloat16* output, aclrtStream stream, llm_kernels::utils::WorkSpaceFunc ws_func);

template <>
void InvokeSiluMul(const float* input, const float* weight, const size_t m, const size_t n, float* output,
